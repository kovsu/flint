...
Similar to Vitest projects and pnpm workspaces, Flint projects help you organize your configurations modularly when working in a monorepo environment.
A configuration at the root of your repo can use `projects` to define a list of glob patterns corresponding to project-level Flint configurations that you'd like to contribute to the top-level Flint execution.
...
If you'd like to get involved and contribute or just find out more, see [flint-fyi/flint#64 🚀 Feature: Config file projects support](https://github.com/flint-fyi/flint/issues/64) for details.
:::
