...
Parsing, reviewing, and iterating on these in good faith takes up much more maintainer bandwidth than traditional contributions, taking away bandwidth from other opportunities to advance Flint.
...
4. Avoid AI-generated content in written, non-code contributions (issues/comments/PR descriptions, etc.).
   - AI PR descriptions in particular tend to just be nearly-verbatim descriptions of the diff, which add no value.
...
Don't let this dissuade you from contributing to Flint!
