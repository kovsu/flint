---
description: "How to effectively contribute to the Flint project."
title: Contributing
---

import { Aside } from "@astrojs/starlight/components";

<Aside icon="heart" title="Please Read" type="tip">
	This project contains a [Contributor Covenant code of
	conduct](/project/code-of-conduct) all contributors are expected to follow.
</Aside>
...
A team member will drop by and help when they can.
...
You can [resolve conversations](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/reviewing-changes-in-pull-requests/commenting-on-a-pull-request#resolving-conversations) on your own when you feel they're resolved - no need to comment explicitly and/or wait for a team member.

#### Requested Changes

After a team member reviews your PR, they may request changes on it.
...
Once your PR is merged, if you haven't yet been added to the [_Contributors_ table in the README.md](https://github.com/flint-fyi/flint#contributors) for the appropriate [type of contribution](https://allcontributors.org/docs/en/emoji-key "Allcontributors emoji key"), you should be soon.
Please do ping the team member who merged your PR if that doesn't happen within 48 hours - it was likely an oversight on our end!
