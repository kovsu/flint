---
description: "Reports quantifiers `{0,1}` in regular expressions that should use `?` instead."
title: "regexQuestionQuantifiers"
topic: "rules"
---
...
<RuleSummary plugin="ts" rule="regexQuestionQuantifiers" />
...
```ts
const pattern = new RegExp("a{0,1}");
```
...
<RuleEquivalents pluginId="ts" ruleId="regexQuestionQuantifiers" />
